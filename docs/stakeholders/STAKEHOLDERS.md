...
|---|---|---|---|
| **CTO** | Strategic alignment, ROI, build-vs-buy | "Why this, why now, what does it cost, when does it pay back?" | [BUSINESS-CASE.md](../business/BUSINESS-CASE.md), [PRESENTATION.md § Exec deck](../business/PRESENTATION.md) |
| **CFO / Finance Director** | TCO, billing accuracy, audit | "Where is the money going, and can I trust the numbers?" | [COST-MODEL.md](../business/COST-MODEL.md), [BUSINESS-CASE.md § ROI](../business/BUSINESS-CASE.md) |
...
| **DPO** | GDPR Arts. 5, 17, 30, 32 | "Lineage, retention, erasure - show me." | [GOVERNANCE.md § GDPR](../governance/GOVERNANCE.md), [GOVERNANCE-PROCEDURES.md](../runbooks/GOVERNANCE-PROCEDURES.md) |
| **Head of Customer Success** | Renewal risk, breach response | "When do I learn about SLO breaches?" | [API.md § /sla](../architecture/API.md), live dashboard demo |
...
| **Capacity Planning** | Fleet utilisation, hardware mix | "Which GPUs are saturated, which are idle?" | [API.md § /utilization](../architecture/API.md) |
| **Platform Engineering (operator)** | Deploy / scale / debug | "What do I run when it breaks?" | [DEPLOYMENT.md](../operations/DEPLOYMENT.md), [GOVERNANCE-PROCEDURES.md § Runbooks](../runbooks/GOVERNANCE-PROCEDURES.md) |
...
- **What you say**:
 ...
 - "OOM kills (137) are billable per current policy; platform errors (143) are not. Both are documented in [COST-MODEL.md § Billing rules](../business/COST-MODEL.md). If you want to change either rule, it's a 30-minute change + 1-day pipeline rebuild."
...
- **What you say**:
 ...
 - "Erasure today is a manual SOP (see [GOVERNANCE-PROCEDURES.md § Subject erasure](../runbooks/GOVERNANCE-PROCEDURES.md)) - 30-day SLA achievable at current volume. Automated pipeline is Phase 4."
 - "Lineage is end-to-end traceable: dbt DAG renders the path from `silver/jobs` - `int_job_costs` - `cost_attribution`. Plus a manual table in [GOVERNANCE.md § Lineage](../governance/GOVERNANCE.md) for an auditor who can't run dbt."
...
- **Artefacts they care about**: [GOVERNANCE.md § GDPR](../governance/GOVERNANCE.md) table (per-article coverage + gap), records of processing, erasure SOP
...
- **What you say**:
 - "Every failure mode has an entry in [ARCHITECTURE.md § Failure modes](../architecture/ARCHITECTURE.md). Runbooks for the top-5 are in [GOVERNANCE-PROCEDURES.md § Runbooks](../runbooks/GOVERNANCE-PROCEDURES.md)."
...
- **Artefacts**: [API.md § /sla](../architecture/API.md), Grafana dashboard (planned), Phase 3 alert integration
...
- **Artefacts**: [API.md § /utilization](../architecture/API.md)
...
- **What you say**:
 ...
 - "Runbooks: [GOVERNANCE-PROCEDURES.md § Runbooks](../runbooks/GOVERNANCE-PROCEDURES.md) covers the top failures. Airflow alerts (planned) wire to PagerDuty."
