...
- Plus residual GDPR fine risk on EU exposure: max - 0M or 4% of revenue - call this $0M expected but tail-risk material

**How this platform fixes it**:
- Lineage end-to-end through dbt DAG + manual trace ([GOVERNANCE.md § Lineage](../governance/GOVERNANCE.md))
- Three-checkpoint quality framework ([GOVERNANCE.md § Quality](../governance/GOVERNANCE.md))
...
|---|---|---|
| DE productivity savings smaller (DS don't adopt the API) | Medium | Roughly halves the $1.7M; payback slips to ~24 months. Mitigation: invest in DS onboarding from week 1 (R8 in [REQUIREMENTS-ANALYSIS.md § Risks](../analysis/REQUIREMENTS-ANALYSIS.md)) |
...
**Next**: [PRESENTATION.md](PRESENTATION.md) for the deck outline; [REQUIREMENTS-ANALYSIS.md](../analysis/REQUIREMENTS-ANALYSIS.md) for the detailed risk register; [COST-MODEL.md](COST-MODEL.md) for the unit economics.          
