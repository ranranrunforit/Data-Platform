...
| `latency_ms` | double | Bimodal; errors are fast (10 - 00 ms) |
...
| `gpu_util_pct` | double | 0 - 00; circadian pattern (peak 14:00 - 2:00 UTC) |
...
The intermediate model `int_job_costs` encodes the billing rules - see [COST-MODEL.md](../business/COST-MODEL.md) for the full logic.
